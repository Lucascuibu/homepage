...
function TopBar() {
    return (
        <div className="uppercase absolute top-0 w-screen h-10 xl:h-12 border-black flex px-3 xl:px-6 xl:text-bse items-center justify-between xl:justify-normal">
