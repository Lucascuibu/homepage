...
export default class DenseMatrix {
	 ...
	 */
	constructor(data: DenseMatrix | any[][]) {
		this.data = data;
	 ...
	 */
	static zeros(m: number, n: number = 1): DenseMatrix {
	 ...
	 * @returns {module:LinearAlgebra.DenseMatrix}
	 */
	static identity(m:number, n = 1): DenseMatrix {
		return new DenseMatrix(DenseMatrix.identity(m, n));
	}
	 ...
	 * @returns {module:LinearAlgebra.DenseMatrix}
	 */
	static ones(m: number, n = 1): DenseMatrix {
		return new DenseMatrix(DenseMatrix.ones(m, n));
	}
	 ...
	 * @returns {module:LinearAlgebra.DenseMatrix}
	 */
	static constant(x: number | undefined, m: number, n = 1): DenseMatrix {
		return new DenseMatrix(DenseMatrix.constant(m, n, x));
	}
	 ...
	 * @returns {module:LinearAlgebra.DenseMatrix}
	 */
	static random(m: any, n = 1): DenseMatrix {
		return new DenseMatrix(DenseMatrix.random(m, n));
	}
	 ...
	 * @returns {module:LinearAlgebra.DenseMatrix}
	 */
	subMatrix(r0: any, r1: any, c0 = 0, c1 = 1): DenseMatrix {
	 ...
	 * @returns {module:LinearAlgebra.DenseMatrix}
	 */
	timesDense(B: { data: any; }): DenseMatrix {
