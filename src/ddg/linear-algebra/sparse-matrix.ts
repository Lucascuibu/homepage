...
class SparseMatrix {
	...
	static fromTriplet(T: Triplet) : SparseMatrix {
		return new SparseMatrix(new SparseMatrix(T.data));
	}
	 ...
	 * @returns {module:LinearAlgebra.SparseMatrix}
	 */
	static identity(m: any, n: any) : SparseMatrix {
		return new SparseMatrix(SparseMatrix.identity(m, n));
	}
	 ...
	 * @returns {module:LinearAlgebra.SparseMatrix}
	 */
	static diag(d: { data: any; }): SparseMatrix {
		return new SparseMatrix(SparseMatrix.diag(d.data));
	}
	 ...
	 * @returns {module:LinearAlgebra.SparseMatrix}
	 */
	subMatrix(r0: any, r1: any, c0: any, c1: any) : SparseMatrix{
	 ...
	 * @returns {module:LinearAlgebra.SparseMatrix}
	 */
	timesSparse(B: { data: any; }) : SparseMatrix{
...
class Cholesky {
	 ...
	 * @returns {module:LinearAlgebra.DenseMatrix}
	 */
	solvePositiveDefinite(b: { data: any; }) : DenseMatrix{
...
class LU {
	 ...
	 * @returns {module:LinearAlgebra.DenseMatrix}
	 */
	solveSquare(b: { data: any; }): DenseMatrix{
...
class QR {
	 ...
	 * @returns {module:LinearAlgebra.DenseMatrix}
	 */
	solve(b: { data: any; }): DenseMatrix{
		return new DenseMatrix(this.data.solve(b.data));
	}
}

export { SparseMatrix, Triplet, Cholesky, LU, QR };